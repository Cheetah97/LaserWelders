...
namespace Cheetah.Networking
{
    public class Syncer<T>
    {
        ...
        /// </summary>
        public Syncer(IMyEntity Entity, string DataID, T Default = default(T), Func<T, bool> Checker = null)
        {
            if (Entity == null) throw new Exception("Syncer: Entity is null!");
            this.DataID = DataID;
            this.Checker = Checker;
            EntityID = Entity.EntityId;
            this.Entity = Entity;
			Underlying = Default;
            Header = $"Syncer|{DataID}";
            Register();
        }
        ...
        public static implicit operator T(Syncer<T> Object)
        {
            return Object.Get();
        }
