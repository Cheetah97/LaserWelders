...
namespace Cheetah.LaserTools
{
    ...
    public static class VanillaToolConstants
    {
        ...
        public static float GrinderSpeed => MyAPIGateway.Session.GrinderSpeedMultiplier * MyShipGrinderConstants.GRINDER_AMOUNT_PER_SECOND * WorkCoefficient / 4;
        public static float WelderSpeed => MyAPIGateway.Session.WelderSpeedMultiplier * 2 * WorkCoefficient / 4; // 2 is WELDER_AMOUNT_PER_SECOND from MyShipWelder.cs
